...
Education = st.selectbox('Education Level', options=['Less than High School', 'High School Graduate', 'Bachelor Degree', 'Master Degree or Ph.D'])
education_numeric = {'Less than High School': 1, 'High School Graduate': 2, 'Bachelor Degree': 3, 'Master Degree or Ph.D': 4}[Education]
